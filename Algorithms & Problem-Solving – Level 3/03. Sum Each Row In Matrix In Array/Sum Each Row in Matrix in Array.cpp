...
void SumMatrixRowsInArray(short arr[3][3], short arrSum[3], short Rows, short Colmuns)
{
	for (short i = 0; i < Rows; i++)
	{
		arrSum[i] = RowSum(arr, i, Colmuns);
	}
}

void PrintRowsSumArray(short arr[3], short Rows)
{
